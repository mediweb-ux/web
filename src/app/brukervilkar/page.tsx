    ...
    <>
        ...
        <section className="py-20 z-5 bg-blue-50" id="brukervilkar" aria-label="Brukervilkår">
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <p className="mt-4 max-w-4xl my-4 text-lg md:text-xl text-gray-600 lg:mx-auto">Disse vilkårene gjelder for alle tjenestene levert av Tr&oslash;nnes MediWeb Solutions («MediWeb Solutions», "MediWeb", «vi», «vår») og på nettsiden www.mediweb.no.
                ...
                <p className="mt-4 max-w-4xl my-4 text-lg md:text-xl text-gray-600 lg:mx-auto">Disse vilkårene og betingelsene ("Avtale") angir de generelle vilkårene for din bruk av mediweb.no ("Nettstedet" eller "Tjenesten") og alle dets relaterte produkter og tjenester (samlet "Tjenester"). 
                    Denne avtalen er juridisk bindende mellom deg ("Bruker", "deg" eller "din") og MediWeb Solutions ("mediweb.no", "vi", "oss" eller "vår"). 
                 ...
                 <p className="mt-4 max-w-4xl my-4 text-lg md:text-xl text-gray-600 lg:mx-auto">Hvis du inngår denne avtalen på vegne av en virksomhet eller annen juridisk enhet, representerer du at du har myndighet til å binde denne enheten til denne avtalen. I så fall vil begrepene "Bruker", "du" eller "din" referere til en slik enhet. 
